 ...
 *
*/
#ifndef __SDS_PARSER__
#define __SDS_PARSER__

#include "sds-condition-tree.h"
#include "sds-cond-parser.h"
#include "sds-cond-lexer.h"

int yyparse(SDS_Condition_tree ***root, yyscan_t scanner);

//Build the conditional tree from a conditional string
//SDS_Condition_tree *parse_condition_tree(const char *expr);
