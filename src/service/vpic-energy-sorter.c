...
int main(int argc, char **argv)
{
  ...
  int c;
  opterr = 0;
  strncpy(filename, "./eparticle_T3810_1.5_filter.h5p", NAME_MAX);
  strncpy(filename_sorted, "./eparticle_T3810_1.5_filter_sorted.h5p", NAME_MAX);
  strncpy(filename_attribute, "./eparticle_T3810_1.5_filter_sorted.attribute", NAME_MAX);
